...
class Interface {
    constructor(scene){
        const size = 64 * Scale;
        this.texts = {
            points1: scene.add.text(Canvas.width/2 - 50, 42 * Scale, '0', {fontFamily: 'Comfortaa', fontSize: size + 'px', stroke: "#111", strokeThickness: size/5}).setOrigin(0.5, 0.5),
            points2: scene.add.text(Canvas.width/2 + 50, 42 * Scale, '0', {fontFamily: 'Comfortaa', fontSize: size + 'px', stroke: "#111", strokeThickness: size/5}).setOrigin(0.5, 0.5),
        ...
        console.log(this.texts.points1)
    }
